 ...
 * AP Statistics.
 *
 * IMPORTANT CONTENT NOTE: College Board revised AP Statistics effective Fall
 * 2026, consolidating the familiar nine units into five and removing several
 * topics. This module keeps the nine-unit study sequence (it is the one most
 * textbooks and most classrooms follow, and it maps cleanly onto a 34-week
 * calendar) but annotates every unit with its home in the current CED, its
 * current official weighting, and any topic that is no longer assessed.
 *
...
export const statistics: Course = {
  ...
  courseNotes: [
    ...
    {
      tone: "warning",
      text: "Topics removed from the revised course: analyzing departures from linearity, combining random variables, the geometric distribution, the chi-square goodness-of-fit test, and all of the old Unit 9 (inference for slopes). Units 8 and 9 below are labeled accordingly - do not spend May review time on material that is no longer assessed.",
    },
    {
      tone: "info",
      text: "The revised CED groups the course into five units: (1) Exploring One-Variable Data and Collecting Data, 20-30%; (2) Probability, Random Variables, and Probability Distributions, 15-25%; (3) Inference for Categorical Data: Proportions, 15-25%; (4) Inference for Quantitative Data: Means, 10-20%; (5) Regression Analysis, 10-20%. Each unit below shows which of those five it belongs to.",
    },
  ],
  resources: [
    {
  ...
  units: [
    /* ------------------------------------------------------------------ */
    {
      ...
      examWeight: "15-23% (legacy CED)",
      examWeightMidpoint: 19,
      classPeriods: "~14-16 class periods",
      summary:
        "Vocabulary, graphs, and the discipline of describing a distribution completely. On the exam 'describe the distribution' always means shape, center, variability, and unusual features - in context, with units.",
      cedNote: {
        tone: "info",
        text: "In the 2026-27 CED this is part of Unit 1: Exploring One-Variable Data and Collecting Data, weighted 20-30% of the multiple-choice section.",
      },
      topics: [
        {
          id: "stat-u1-t1",
      ...
      practiceSet: {
        id: "stat-u1-ps",
        title: "Unit 1 Practice: One-Variable Data",
        focus:
          "Summary statistics, outlier rules, normal calculations, and writing a complete comparison of two distributions.",
        estimatedMinutes: 40,
        calculator: "allowed",
        problems: [
          {
    ...
    /* ------------------------------------------------------------------ */
    {
      ...
      examWeight: "5-7% (legacy CED)",
      examWeightMidpoint: 6,
      classPeriods: "~10-11 class periods",
      summary:
        "Scatterplots, correlation, and least-squares regression, plus two-way tables for two categorical variables. Interpreting slope and r-squared in context is tested somewhere on essentially every exam.",
      cedNote: {
        tone: "info",
        text: "In the 2026-27 CED, the regression material here forms Unit 5: Regression Analysis (10-20%), and the two-way table material opens Unit 2. 'Analyzing departures from linearity' was removed from the course.",
      },
      topics: [
        {
          id: "stat-u2-t1",
      ...
      practiceSet: {
        id: "stat-u2-ps",
        title: "Unit 2 Practice: Two-Variable Data",
        focus:
          "Building a regression line from summary statistics, residuals, r-squared interpretation, and reading computer output.",
        estimatedMinutes: 45,
        calculator: "allowed",
        problems: [
          {
          ...
          },
          {
            ...
            parts: [
              { label: "(a)", text: "Find the marginal distribution of sport participation." },
              { label: "(b)", text: "Find the conditional distribution of sport participation for each grade level." },
              { label: "(c)", text: "Does the table suggest an association between grade level and sport participation? Support your answer with appropriate percentages." },
              { label: "(d)", text: "Explain why a segmented bar chart of the conditional distributions would be a better display here than a bar chart of the raw counts." },
            ],
            solution:
              "(a) Out of 500 students, 270 play a sport and 230 do not, so the marginal distribution is 270/500 = 54% play a sport and 230/500 = 46% do not.\n\n(b) Among the 200 freshmen: 120/200 = 60% play a sport and 80/200 = 40% do not. Among the 300 seniors: 150/300 = 50% play a sport and 150/300 = 50% do not.\n\n(c) Yes, the table suggests an association. A greater percentage of freshmen (60%) play a school sport than seniors (50%). Because the conditional distributions of sport participation differ by grade level, the two variables appear associated in this sample. (Whether that 10 percentage point difference is statistically significant would require a chi-square test.)\n\n(d) The two grade groups have different sizes - 200 freshmen versus 300 seniors. Raw counts would show 150 seniors playing sports versus 120 freshmen, making it look as if seniors participate more, when the rate is actually lower. Segmented bars of conditional percentages put both groups on the same 0-100% scale so the comparison is fair.",
            rubric: [
              { points: "2 pts", criterion: "Correct marginal distribution as percentages with the grand total as denominator." },
              { points: "3 pts", criterion: "Correct conditional distributions using row totals." },
              { points: "3 pts", criterion: "Claims association and cites the 60% versus 50% comparison." },
              { points: "2 pts", criterion: "Explains that unequal group sizes make raw counts misleading." },
            ],
            note: "Part (d) is the conceptual heart of two-way tables. Unequal group sizes are exactly why conditional percentages exist.",
          },
        ],
      },
    },
    /* ------------------------------------------------------------------ */
    {
      ...
      examWeight: "12-15% (legacy CED)",
      examWeightMidpoint: 13.5,
      classPeriods: "~12-14 class periods",
      summary:
        "No calculations, high stakes. This unit decides whether your later conclusions may generalize to a population (random selection) or claim causation (random assignment). Free-response questions here are pure writing.",
      cedNote: {
        tone: "info",
        text: "In the 2026-27 CED this material sits in Unit 1: Exploring One-Variable Data and Collecting Data, weighted 20-30% together with one-variable data.",
      },
      topics: [
        {
          id: "stat-u3-t1",
      ...
      practiceSet: {
        id: "stat-u3-ps",
        title: "Unit 3 Practice: Collecting Data",
        focus:
          "Identifying designs and bias types, and writing complete descriptions of a randomized experiment and a sampling plan.",
        estimatedMinutes: 40,
        calculator: "n/a",
        problems: [
          {
    ...
    /* ------------------------------------------------------------------ */
    {
      ...
      examWeight: "10-20% (legacy CED)",
      examWeightMidpoint: 15,
      classPeriods: "~18-20 class periods",
      summary:
        "The most mathematical unit in the course. Everything later depends on the binomial and normal models and on being able to compute the mean and standard deviation of a random variable.",
      cedNote: {
        tone: "warning",
        text: "In the 2026-27 CED this is Unit 2: Probability, Random Variables, and Probability Distributions (15-25%), and it now also contains sampling distributions and the Central Limit Theorem. Two topics were removed from the course: combining random variables and the geometric distribution.",
      },
      topics: [
        {
          id: "stat-u4-t1",
      ...
      practiceSet: {
        id: "stat-u4-ps",
        title: "Unit 4 Practice: Probability and Random Variables",
        focus:
          "Addition and conditional rules, expected value and standard deviation, and a complete binomial analysis.",
        estimatedMinutes: 50,
        calculator: "allowed",
        problems: [
          {
    ...
    /* ------------------------------------------------------------------ */
    {
      ...
      examWeight: "7-12% (legacy CED)",
      examWeightMidpoint: 9.5,
      classPeriods: "~10-11 class periods",
      summary:
        "The bridge from probability to inference, and conceptually the hardest unit in the course. The central idea: a statistic computed from a random sample is itself a random variable, with its own center, spread, and shape.",
      cedNote: {
        tone: "info",
        text: "In the 2026-27 CED sampling distributions are distributed across Unit 2 (the Central Limit Theorem) and the openings of Units 3 and 4 (sampling distributions for proportions and means).",
      },
      topics: [
        {
          id: "stat-u5-t1",
      ...
      practiceSet: {
        id: "stat-u5-ps",
        title: "Unit 5 Practice: Sampling Distributions",
        focus:
          "Computing standard deviations of statistics, checking normality conditions, and finding probabilities about p-hat and x-bar.",
        estimatedMinutes: 45,
        calculator: "allowed",
        problems: [
          {
          ...
          },
          {
            ...
            label: "FRQ 1",
            prompt:
              "A city claims that 35% of its residents commute by public transit. A researcher plans to take a simple random sample of 200 residents from the city's population of 480,000.",
            parts: [
              { label: "(a)", text: "Describe the sampling distribution of p-hat, the sample proportion who commute by transit, including shape, center, and standard deviation. Verify all conditions." },
              { label: "(b)", text: "Find the probability that more than 40% of the sample commutes by transit." },
              { label: "(c)", text: "The researcher's sample yields p-hat = 0.46. Does this provide reason to doubt the city's 35% claim? Explain using your sampling distribution." },
            ],
            solution:
              "(a) Conditions: the sample is a simple random sample, so observations are independent of one another in selection. The 10% condition holds because 200 is far less than 10% of 480,000 (which is 48,000). The large-counts condition holds because np = 200(0.35) = 70 ≥ 10 and n(1 - p) = 200(0.65) = 130 ≥ 10. Therefore the sampling distribution of p-hat is approximately normal, centered at p = 0.35, with standard deviation sqrt(0.35(0.65)/200) = sqrt(0.0011375) = 0.0337.\n\n(b) z = (0.40 - 0.35)/0.0337 = 1.4825. The area above that z is 1 - 0.9309 = 0.0691. There is about a 6.9% chance that a random sample of 200 gives a sample proportion above 0.40.\n\n(c) The observed p-hat = 0.46 is (0.46 - 0.35)/0.0337 = 3.26 standard deviations above the claimed proportion. A result that extreme has probability about 0.0006 if the city's claim is true. Because such a sample would be so unlikely under the claim, this sample gives strong reason to doubt that only 35% of residents commute by transit; the true proportion appears to be higher.",
            rubric: [
              { points: "2 pts", criterion: "Checks randomness, the 10% condition with numbers, and large counts with numbers." },
              { points: "2 pts", criterion: "States approximately normal, center 0.35, SD 0.0337." },
              { points: "3 pts", criterion: "Correct z-score and probability 0.0691." },
              { points: "3 pts", criterion: "Computes the z-score for 0.46, notes how unlikely it is, and concludes in context." },
            ],
            note: "Part (c) is a significance test in disguise. Notice that the reasoning - 'how surprising is this statistic if the claim is true' - is exactly the logic of a p-value.",
          },
          {
            id: "stat-u5-p6",
            kind: "free-response",
    ...
    /* ------------------------------------------------------------------ */
    {
      ...
      examWeight: "12-15% (legacy CED)",
      examWeightMidpoint: 13.5,
      classPeriods: "~16-18 class periods",
      summary:
        "The first full inference unit and the template for everything that follows: state hypotheses and parameters, plan by naming the procedure and checking conditions, do the computation, and conclude in context with linkage to the p-value.",
      cedNote: {
        tone: "info",
        text: "In the 2026-27 CED this is Unit 3: Inference for Categorical Data: Proportions (15-25%), and it now also contains the chi-square tests for homogeneity and independence.",
      },
      topics: [
        {
          id: "stat-u6-t1",
      ...
      practiceSet: {
        id: "stat-u6-ps",
        title: "Unit 6 Practice: Inference for Proportions",
        focus:
          "Margin of error, sample size, a complete one-proportion z-test, and a two-proportion confidence interval.",
        estimatedMinutes: 55,
        calculator: "allowed",
        problems: [
          {
    ...
    /* ------------------------------------------------------------------ */
    {
      ...
      examWeight: "10-18% (legacy CED)",
      examWeightMidpoint: 14,
      classPeriods: "~16-18 class periods",
      summary:
      ...
      cedNote: {
        tone: "info",
        text: "In the 2026-27 CED this is Unit 4: Inference for Quantitative Data: Means, weighted 10-20% of the multiple-choice section.",
      },
      topics: [
        {
          id: "stat-u7-t1",
      ...
      practiceSet: {
        id: "stat-u7-ps",
        title: "Unit 7 Practice: Inference for Means",
        focus:
          "One-sample t intervals and tests, a full matched-pairs analysis, and a two-sample t-test with correct df.",
        estimatedMinutes: 55,
        calculator: "allowed",
        problems: [
          {
    ...
    /* ------------------------------------------------------------------ */
    {
      ...
      examWeight: "2-5% (legacy CED)",
      examWeightMidpoint: 3.5,
      classPeriods: "~10-11 class periods",
      summary:
        "Chi-square procedures compare observed counts with expected counts. Small unit, but it reliably shows up in multiple choice, and the homogeneity-versus-independence distinction is a favorite question.",
      cedNote: {
        tone: "warning",
        text: "For 2026-27 the chi-square goodness-of-fit test was REMOVED from AP Statistics. Only the tests for homogeneity and independence remain, and they now live inside Unit 3: Inference for Categorical Data: Proportions (15-25%). The practice set below covers only the two tests still assessed.",
      },
      topics: [
        {
          id: "stat-u8-t1",
      ...
      practiceSet: {
        id: "stat-u8-ps",
        title: "Unit 8 Practice: Chi-Square Tests",
        focus:
          "Expected counts, degrees of freedom, choosing between homogeneity and independence, and a complete chi-square test.",
        estimatedMinutes: 45,
        calculator: "allowed",
        problems: [
          {
            ...
            label: "MCQ 1",
            prompt:
              "A chi-square test is performed on a table with 3 rows and 4 columns of categories. How many degrees of freedom does the test have?",
            choices: [
              { label: "A", text: "3" },
              { label: "B", text: "6" },
              { label: "C", text: "7" },
            ...
            note: "Choice D is (total cells) - 1 = 11, which is the goodness-of-fit style count and does not apply to two-way tables.",
          },
          {
            id: "stat-u8-p2",
            kind: "multiple-choice",
            label: "MCQ 2",
            prompt:
              "In a two-way table, one row total is 100, one column total is 70, and the grand total is 200. What is the expected count for that cell?",
            choices: [
              { label: "A", text: "14" },
              { label: "B", text: "35" },
              { label: "C", text: "70" },
            ...
            answer: "B",
            solution:
              "Expected count = (row total)(column total)/(grand total) = 100(70)/200 = 7000/200 = 35.",
          },
          {
            id: "stat-u8-p3",
            kind: "multiple-choice",
          ...
          },
          {
            ...
            label: "MCQ 4",
            prompt:
              "A chi-square test yields a p-value of 0.28 at alpha = 0.05. Which conclusion is correctly worded?",
            choices: [
              { label: "A", text: "The two variables are independent." },
              { label: "B", text: "We accept the null hypothesis that the variables are independent." },
              { label: "C", text: "There is not convincing evidence of an association between the two variables." },
              { label: "D", text: "There is convincing evidence that the variables are not associated." },
            ],
            answer: "C",
            solution:
              "A large p-value means the data are consistent with the null hypothesis, not that the null is true. The only defensible statement is that the evidence is insufficient to conclude an association exists.",
            note: "Never write 'accept H0' and never write 'we proved there is no association'. Failing to find evidence is not the same as finding evidence of nothing.",
          },
          {
            id: "stat-u8-p5",
            kind: "free-response",
    ...
    /* ------------------------------------------------------------------ */
    {
      ...
      examWeight: "Not assessed in 2026-27 (was 2-5%)",
      examWeightMidpoint: 0,
      classPeriods: "~7-8 class periods",
      summary:
        "Inference for a regression slope: confidence intervals and significance tests for beta, read off computer output. This unit was removed from AP Statistics for the 2026-27 school year, so treat it as optional enrichment rather than exam preparation.",
      cedNote: {
        tone: "warning",
        text: "REMOVED FOR 2026-27. College Board eliminated Unit 9: Inference for Quantitative Data: Slopes from AP Statistics effective Fall 2026. It is kept here because the ideas are useful for a college course and because some teachers still cover it, but it will NOT appear on the May 2027 exam. Skip it if you are short on time, and confirm with your teacher.",
      },
      topics: [
        {
          id: "stat-u9-t1",
          title: "The slope of a sample regression line as a statistic",
          detail:
            "The computed slope b estimates the unknown population slope beta and varies from sample to sample.",
        },
        {
          id: "stat-u9-t2",
          title: "Conditions for regression inference",
          detail:
            "Linear form, independent observations, roughly constant residual spread, and approximately normal residuals - checked with a residual plot.",
        },
        {
          id: "stat-u9-t3",
          title: "Confidence interval for a slope",
          detail:
            "b plus or minus t* times SE(b), with df = n - 2. Both b and SE(b) come straight from computer output.",
        },
        {
          id: "stat-u9-t4",
          title: "Significance test for a slope",
          detail:
            "H0: beta = 0 against a two-sided alternative, with t = b/SE(b) and df = n - 2. Rejecting means there is evidence of a linear relationship.",
        },
        {
          id: "stat-u9-t5",
          title: "Reading standard error of the slope from output",
          detail:
            "The SE Coef column beside the slope estimate is SE(b). The printed t and p-value are for H0: beta = 0.",
        },
        {
          id: "stat-u9-t6",
          title: "Interpreting a slope interval in context",
          detail:
            "Describe a plausible range for the predicted change in the response per one-unit increase in the explanatory variable.",
        },
      ],
      keySkills: [
        "Slope test statistic: t = b/SE(b), df = n - 2",
        "Slope interval: b ± t*SE(b)",
        "An interval excluding 0 is evidence of a linear relationship",
        "Conditions checked with a residual plot: linearity, constant spread, normality",
      ],
      commonMistakes: [
        "Using df = n - 1 instead of n - 2.",
        "Interpreting the interval as capturing the sample slope rather than the population slope.",
        "Concluding causation from a significant slope in observational data.",
      ],
      practiceSet: {
        id: "stat-u9-ps",
        title: "Unit 9 Practice: Inference for Slopes (enrichment)",
        focus:
          "Slope tests and intervals from computer output. Not assessed on the May 2027 exam - do this set only if your class covers it.",
        estimatedMinutes: 30,
        calculator: "allowed",
        problems: [
          {
            ...
            label: "MCQ 1",
            prompt:
              "A regression is based on n = 20 observations. How many degrees of freedom does inference for the slope use?",
            choices: [
              { label: "A", text: "18" },
              { label: "B", text: "19" },
              { label: "C", text: "20" },
            ...
            answer: "A",
            solution:
              "Regression inference uses df = n - 2 = 20 - 2 = 18, because two parameters (the intercept and the slope) are estimated from the data.",
          },
          {
            id: "stat-u9-p2",
            kind: "multiple-choice",
            label: "MCQ 2",
            prompt:
              "Computer output gives a slope estimate of 4.60 with SE Coef 0.82. What is the test statistic for H0: beta = 0?",
            choices: [
              { label: "A", text: "0.18" },
              { label: "B", text: "3.78" },
              { label: "C", text: "5.61" },
            ...
            answer: "C",
            solution:
              "t = b/SE(b) = 4.60/0.82 = 5.61.",
            note: "Choice A inverts the ratio. The estimate always goes on top, divided by its own standard error.",
          },
          {
            id: "stat-u9-p3",
            kind: "multiple-choice",
            label: "MCQ 3",
            prompt:
              "With n = 20, b = 4.60, and SE(b) = 0.82, what is the 95% confidence interval for the population slope? (t* = 2.101 for df = 18)",
            choices: [
              { label: "A", text: "(3.78, 5.42)" },
              { label: "B", text: "(2.88, 6.32)" },
              { label: "C", text: "(2.99, 6.21)" },
              { label: "D", text: "(-1.72, 11.02)" },
            ],
            answer: "B",
            solution:
              "The margin of error is t*SE(b) = 2.101(0.82) = 1.723. The interval is 4.60 ± 1.723 = (2.877, 6.323), which rounds to (2.88, 6.32).",
          },
          {
            id: "stat-u9-p4",
            kind: "free-response",
            ...
            parts: [
              { label: "(a)", text: "Test whether there is a linear relationship between hours studied and exam score, at alpha = 0.05." },
              { label: "(b)", text: "Construct and interpret a 95% confidence interval for the slope." },
              { label: "(c)", text: "Can the researcher conclude that studying more causes higher exam scores? Explain." },
            ],
            solution:
              "(a) Let beta be the true slope of the population regression line relating exam score to hours of weekly study. H0: beta = 0 and Ha: beta is not equal to 0. The test statistic is t = b/SE(b) = 4.60/0.82 = 5.61 with df = n - 2 = 18. The two-sided p-value is about 0.000025, far below 0.05. We reject H0: there is convincing evidence of a linear relationship between hours of weekly study and exam score. (Conditions: students were randomly selected, and we would examine a residual plot for linear form and roughly constant spread before trusting this result.)\n\n(b) With t* = 2.101 for df = 18, the interval is 4.60 ± 2.101(0.82) = 4.60 ± 1.723 = (2.877, 6.323). We are 95% confident that the interval from 2.877 to 6.323 captures the true slope - that is, each additional hour of weekly study is associated with a predicted increase of between about 2.9 and 6.3 points on the exam. Because the interval is entirely above 0, it agrees with the test's rejection of beta = 0.\n\n(c) No. These data are observational: the researcher recorded how much students happened to study rather than assigning study hours at random. Variables such as prior preparation, motivation, and course difficulty are plausibly related both to study time and to exam score, so they confound the relationship. A causal conclusion would require randomly assigning students to different amounts of study time.",
            rubric: [
              { points: "2 pts", criterion: "Hypotheses about beta with the parameter defined in context." },
              { points: "2 pts", criterion: "t = 5.61 with df = 18 and a p-value below 0.05." },
              { points: "1 pt", criterion: "Conclusion in context with linkage." },
              { points: "2 pts", criterion: "Interval (2.88, 6.32) with a correct slope interpretation." },
              { points: "3 pts", criterion: "Denies causation and names confounding in an observational study." },
            ],
            note: "Even though this unit is no longer assessed, part (c) is a scope-of-inference question that absolutely is - observational data never licenses causation.",
          },
        ],
      },
    },
